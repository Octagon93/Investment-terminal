...
def stars(score):
    if score >= 85:
        ...
        return "⭐☆☆☆☆"
MY_PORTFOLIO = (
    "NVDA,AMZN,CRWD,ONON,SNOW,TTWO,BYDDF,RHM.DE,"
    "ANET,GOOGL,META,MSFT,AVGO,ASML,TSM,AMD,CRM,PANW,PLTR,DDOG,NVO"
)

NASDAQ_100 = (
AAPL,MSFT,NVDA,AMZN,META,GOOGL,AVGO,TSLA,COST,NFLX,AMD,PEP,ADBE,CSCO,
...
BKR,ON,CDW,ANSS,WBD,ILMN,GFS,ARM,NVO,CRM,TSM,THEON,IBKR,ANET,ORCL,
ASML,APH,SNDK,DELL,SOFI,AVAV,PLTR,INTC,QBTS
)
